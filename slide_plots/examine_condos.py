...
in_bdy = gdf[gdf.geometry.within(gpd_cont.geometry[0])]

#
# # This throws a warning that will need to be fixed.
in_bdy = add_required_salary_to_dataframe(in_bdy, 0, 0.062/12, 0.0115/12, 0.01/12)
#
# scale_value = 1e6
# plt.close(3456)
# plt.figure(3456)
